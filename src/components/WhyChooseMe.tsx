...
const WhyChooseMe = () => {
  ...
  return (
    <section id="why-choose-me" className="section-padding bg-white dark:bg-slate-950 transition-colors duration-500 overflow-hidden">
      <div className="container mx-auto">
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3 mb-16">
          {reasons.map((reason, index) => (
            <Card
              key={index}
              className="border border-gray-200 dark:border-slate-800 dark:bg-slate-900/50 hover:shadow-lg transition-all duration-300 hover:-translate-y-1 animate-fade-in"
              style={{ animationDelay: `${index * 0.1}s` }}
            >
              <CardContent className="p-6 text-center">
                <div className="w-16 h-16 bg-portfolio-100 dark:bg-portfolio-900/30 text-portfolio-600 dark:text-portfolio-400 rounded-full flex items-center justify-center mx-auto mb-4 hover:scale-110 transition-transform duration-300">
                  <reason.icon size={32} />
                </div>
        ...
        <div className="bg-gradient-to-r from-portfolio-50 to-portfolio-100 dark:from-slate-900 dark:to-slate-800 rounded-2xl p-8 md:p-12 text-center animate-fade-in">
