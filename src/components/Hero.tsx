...
const Hero = () => {
  return (
    <section id="home" className="pt-28 pb-16 md:pt-36 md:pb-24 bg-gradient-to-br from-blue-50 to-white dark:from-slate-900 dark:to-slate-950 transition-colors duration-500">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-10">
          ...
          <div className="w-full md:w-1/2 space-y-6 animate-fade-in">
            ...
            <div className="flex flex-wrap gap-4 pt-2">
              ...
              <Button variant="outline" className="border-portfolio-500 text-portfolio-600 dark:text-portfolio-400 hover:bg-portfolio-50 dark:hover:bg-portfolio-900/20 hover-scale">
