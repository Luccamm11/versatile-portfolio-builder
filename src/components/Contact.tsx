    ...
    <section id="contact" className="section-padding bg-gray-50 dark:bg-slate-900 transition-colors duration-500">
      <div className="container mx-auto">
        <div className="text-center mb-16 animate-fade-in">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 dark:text-white mb-4">Entre em Contato</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          <div className="space-y-8 animate-fade-in">
            <h3 className="text-2xl font-bold text-gray-800 dark:text-white">Vamos Conversar</h3>
            ...
            <div className="space-y-4">
              <div className="flex items-center hover-scale">
                <div className="w-12 h-12 bg-portfolio-100 dark:bg-portfolio-900/30 text-portfolio-600 dark:text-portfolio-400 rounded-full flex items-center justify-center mr-4">
                  <MapPin size={24} />
                </div>
                <div>
                  <h4 className="font-semibold text-gray-800 dark:text-white">Localização</h4>
                  <p className="text-gray-600 dark:text-gray-400">Minas Gerais, Brasil</p>
                </div>
              </div>
              ...
              <div className="flex items-center hover-scale">
                ...
                <div>
                  ...
                  <a href="mailto:luccammiranda@gmail.com" className="text-portfolio-600 dark:text-portfolio-400 hover:underline">luccammiranda@gmail.com</a>
                </div>
              </div>
              ...
              <div className="flex items-center hover-scale">
                ...
                <div>
                  ...
                  <a href="tel:+5537998084178" className="text-portfolio-600 dark:text-portfolio-400 hover:underline">(37) 99808-4178</a>
                </div>
              </div>
            </div>

            <div className="mt-8">
              <h4 className="font-bold text-gray-800 dark:text-white mb-4">Me encontre online</h4>
              <a
